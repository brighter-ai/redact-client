...
def redact_file(file_path: str,
                ...
                api_key: Optional[str] = typer.Option(settings.redact_online_url,
                ...
                skip_existing: bool = typer.Option(True, help='Specify whether to overwrite previously run files'),
                auto_delete_job: bool = typer.Option(True,
