...
class TestRedactRequests:
    ...
    def test_upload_from_disk(self, redact_requests, some_image):
        ...
        redact_requests.post_job(file=some_image, service=ServiceType.blur, out_type=OutputType.images)
    ...
    def test_upload_from_memory(self, redact_requests, some_image):
        ...
        redact_requests.post_job(file=img, service=ServiceType.blur, out_type=OutputType.images)
