...
class TestRedactToolsWithSubscriptionKey:
    ...
    def test_redact_folder_with_invalid_api_key_fails(self, images_path, tmp_path_factory, caplog):
    ...
    def test_redact_folder_with_valid_api_key(self, images_path, api_key, tmp_path_factory):
